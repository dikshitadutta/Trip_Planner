      ...
      <div className="relative z-10 container mx-auto px-4 py-20 grid grid-cols-1 lg:grid-cols-2 gap-8 items-center">
        ...
        <div className="flex flex-col gap-6 text-white">
          ...
          <h1 className="text-5xl lg:text-6xl font-bold leading-tight text-pretty">
            Discover the Seven Sisters
          </h1>

          <p className="text-lg text-gray-200 leading-relaxed max-w-md">
            Experience the untouched beauty of North East India&apos;s seven stunning states with personalized
          ...
          <div className="grid grid-cols-3 gap-4 pt-8 border-t border-white/10">
            <div className="text-center">
              ...
              <div className="text-sm text-gray-300">States to Explore</div>
            </div>
            <div className="text-center">
              <div className="text-2xl font-bold text-emerald-400">100+</div>
              <div className="text-sm text-gray-300">Curated Tours</div>
            </div>
            <div className="text-center">
